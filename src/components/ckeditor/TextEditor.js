...
const TextEditor = ({ content, setData }) => {
    const edrtorConfiguration = {
        toolbar: {
            items: ["heading", "|", "bold", "italic", "link", "bulletedList", "numberedList", "|", "outdent", "indent", "|", "imageUpload", "blockQuote", "mediaEmbed", "undo", "redo"],
        },
        language: "ko",
        image: {
    ...
    return (
        <CKEditor
            ...
            data={content || "<p> 이곳에 내용을 작성해 주세요!</p>"}
