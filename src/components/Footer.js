            ...
            <div className="footer-content">
                <div className="company-info">
                    ...
                    <div className="sns-icons">
                        <img className="icon" src={require("../assets/instagram.png")} alt="Instagram" />
                        <img className="icon" src={require("../assets/facebook.png")} alt="Facebook" />
                        <img className="icon" src={require("../assets/twitter.png")} alt="Twitter" />
                        <img className="icon" src={require("../assets/youtube.png")} alt="YouTube" />
                    </div>
                </div>
