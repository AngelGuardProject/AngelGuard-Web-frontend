            ...
            <div className={style.footerContent}>
                <div className={style.companyInfo}>
                    ...
                    <div className={style.snsIcons}>
                        <img className={style.icon} src={require("../assets/instagram.png")} alt="Instagram" />
                        <img className={style.icon} src={require("../assets/facebook.png")} alt="Facebook" />
                        <img className={style.icon} src={require("../assets/twitter.png")} alt="Twitter" />
                        <img className={style.icon} src={require("../assets/youtube.png")} alt="YouTube" />
                    </div>
                </div>
